 ...
 */
public final class ErrorPage extends AuthenticatedWebPage {
	/**
	...
	public ErrorPage(final PageParameters parameters)
			throws StringValueConversionException {
		this(parameters.getString("exceptionMessage"));
	}
	 ...
	 *            The model
	 */
	public ErrorPage(final String exceptionMessage) {
		add(new Label("An error occured: ", exceptionMessage));
	}
	 ...
	 */
	public static PageLink link(final String name, final String exceptionMessage) {
		return new PageLink(name, new IPageLink() {
			public Page getPage() {
				return new ErrorPage(exceptionMessage);
			}
