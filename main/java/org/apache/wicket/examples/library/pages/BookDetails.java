...
import org.apache.wicket.examples.library.dao.Book.WritingStyle;
...
public final class BookDetails extends AuthenticatedWebPage {
	...
	public BookDetails(final Book book) {
		...
		add(BookDetails.link("related", book.getRelatedBook(), getLocalizer()
		...
		final AttributeModifier italic = new AttributeModifier("class",
				new Model<String>("italic"));
